...
We provide two files for this assignment. One is a sample file where we give you the sum for your testing
 and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_1095708.json (Sum ends with 56)
...
url= " http://py4e-data.dr-chuck.net/comments_1095708.json"
print('Obteniendo URL. Espere un momento')
